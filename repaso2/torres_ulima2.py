...
class Regulador:
    ...
    def on_supera_umbral(self, consumo):
        self.historicoUmbrales.agregar_registro(consumo)
        self.notificador.alert()
...
class Componente:
    ...
    def agregar_observadores(self, regulador):
        self._observadores.append(regulador)
        
    def notificar_consumo(self, umbral):
        for regulador in self._observadores:
            if self.obtener_consumo() > umbral:
                regulador.on_supera_umbral(self.consumo)
                self.actualizar_luminosidad_en(0.9)
...
class Edificio:
    def __init__(self):
        ...
        self.torres = Torres()
        self.torres.agregar_observadores(self.regulador)
        self.torreA = Torre()
        self.torreB = Torre()
        piso1A = Piso()
        piso2A = Piso()
    ...
    def actualizar_luminosidad_en(self, luminosidad):
        ...
        umbral = 2000
        self.torres.notificar_consumo(umbral)
